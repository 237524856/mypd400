...
//    imageLabel->resize(154,49);
//    imageLabel->move(10,10);
//    imageLabel->setPixmap(QPixmap(":/image/images/mbs400_maono.png"));
...
void MyTitleBar::initControl()
{
    ...
    m_pButtonMax->setFixedSize(QSize(0, 0));
...
//    m_pButtonClose->setToolTip(QStringLiteral("关闭"));
    ...
    mylayout->setContentsMargins(5, 0, 20, 0);
    mylayout->setSpacing(17);
